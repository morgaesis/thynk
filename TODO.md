...
- [ ] **Fix display** - Backlinks shows `see \[\[other note\]\]`; should not show the backslashes
...
### Model Discovery
- [ ] **Auto-discover models** - When user enters API key, query model list from provider; don't maintain hardcoded list